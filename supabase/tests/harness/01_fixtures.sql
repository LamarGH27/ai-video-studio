...
values
  (avs_test.id('a_submitted'), avs_test.id('customer_a'), 'SUBMITTED',
   'Customer A submitted brief, long enough to satisfy the completeness constraint.',
   'VERTICAL_9_16', 15, now()),
  (avs_test.id('b_submitted'), avs_test.id('customer_b'), 'SUBMITTED',
...
values
  (avs_test.id('a_submitted'), avs_test.id('customer_a'), 'HAS_LIKENESS_PERMISSION', true, '2026-01-01', now()),
  (avs_test.id('a_submitted'), avs_test.id('customer_a'), 'AI_PROCESSING_CONSENT',   true, '2026-01-01', now()),
  (avs_test.id('b_submitted'), avs_test.id('customer_b'), 'HAS_LIKENESS_PERMISSION', true, '2026-01-01', now()),
  (avs_test.id('b_submitted'), avs_test.id('customer_b'), 'AI_PROCESSING_CONSENT',   true, '2026-01-01', now());
